...
parser.add_argument('--use_loss_mcc', type=bool,default=False,help='Use the mcc loss')
parser.add_argument('--use_frame_self_attention', type=bool, default=False, help='Use attention mechanism before fc')
parser.add_argument('--use_relation_self_attention', type=bool, default=False, help='Use attention mechanism after trm')
parser.add_argument('--augmented_inputs', type=bool, default=False, help='Use attention mechanism after trm')
...
parser.add_argument('--lr2', '--learning_rate2', default=0.00001, type=float,
                    metavar='LR2', help='initial learning rate')
